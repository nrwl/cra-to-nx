...
function setupTsConfig() {
    ...
    if (fileExists('apps/webapp/tsconfig.base.json')) {
        ...
        fs.writeFileSync('apps/webapp/tsconfig.base.json', JSON.stringify(json, null, 2));
    }
    else {
        fs.writeFileSync('apps/webapp/tsconfig.base.json', JSON.stringify(defaultTsConfigBase, null, 2));
    }
